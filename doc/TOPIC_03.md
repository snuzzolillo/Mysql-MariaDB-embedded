...
The code generated by the precompiler handles the Bind Variable in a case-insensitive way. This could cause some problems if we do not take due care. Let's look at an example to understand the problem:
```
...
|PRECOMPILER BUILD CODE|PHP AFTER EXECUTION ASSIGNMENT|
|--|--|
...
|	,@VAR as VAr;|$VAr = array['VAr']; // Last Value of @VAR = 4|
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzQ1MTc1MjldfQ==
-->